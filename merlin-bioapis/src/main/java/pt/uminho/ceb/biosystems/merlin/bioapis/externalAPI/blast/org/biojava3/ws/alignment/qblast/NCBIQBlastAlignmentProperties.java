...
RemotePairwiseAlignmentProperties {
	 ...
	 * 
	 * @param g
	 *            : an integer to use as HitlistSize
	 * 
	 */
	 ...
	 * 
	 * @return g :the value for the HitlistSize used by this search
	 * 
	 */
	...
	public String getAlignmentOption(String key) throws Exception {
		if (param.containsKey(key)) {
			...
			System.err.println("The key named " + key
	...
	public void setAlignmentOption(String key, String val) {
